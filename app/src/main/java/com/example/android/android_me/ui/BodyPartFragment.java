...
public class BodyPartFragment extends Fragment {
    ...
    private static final String LIST_INDEX_STATE_KEY = "LIST_INDEX_STATE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(LIST_STATE_KEY);
            mListIndex = savedInstanceState.getInt(LIST_INDEX_STATE_KEY);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(LIST_STATE_KEY,  (ArrayList<Integer>) mImageIds);
        outState.putInt(LIST_INDEX_STATE_KEY, mListIndex);
    }
}
